''' written by Krishna Chauhan on 06th Feb,2024 '''
...
city_info_label = test_canvas.create_text(210,40,text="City Name",fill="#FF0000",font=(FONT_HERSHEY_COMPLEX,20,'bold'))
